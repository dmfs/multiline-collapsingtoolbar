...
public class CollapsingToolbarLayout extends FrameLayout
{
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr)
    {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, net.opacapp.multilinecollapsingtoolbar.R.styleable.CollapsingToolbarLayoutExtension,
                defStyleAttr, 0);
        mCollapsingTextHelper.setMaxLines(
                typedArray.getInteger(net.opacapp.multilinecollapsingtoolbar.R.styleable.CollapsingToolbarLayoutExtension_maxLines, 3));
        typedArray.recycle();
        // END MODIFICATION
    }
        ...
        if (mScrimAnimator == null)
        {
            ...
            mScrimAnimator.addUpdateListener(new ValueAnimatorCompat.AnimatorUpdateListener()
            {
                ...
                public void onAnimationUpdate(ValueAnimatorCompat animator)
                {
                    ...
                    float fraction =
                            animator.getAnimatedIntValue() / (float) 0xff;
                    mCollapsingTextHelper.setTransitionFraction(fraction);
                }
            });
        }
    ...
    void setScrimAlpha(int alpha)
    {
        ...
        {
            float fraction = alpha / (float) 0xff;
            for (int i = 0, z = getChildCount(); i < z; i++)
            {
                final View child = getChildAt(i);
                ...
                switch (lp.mScrimMode)
                {
                    case 1:
                        ...
                        {
                            child.setVisibility(fraction < 0.5 ? VISIBLE : GONE);
                        }
                        else
                        {
                    ...
                    case 2:
                        if (Build.VERSION.SDK_INT < 11)
                        {
                            child.setVisibility(fraction < 0.5 ? GONE : VISIBLE);
                        }
                        else
                        {
                            child.setAlpha(fraction);
                        }
                        break;
                }
            }
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams
    {
        ...
        public LayoutParams(Context c, AttributeSet attrs)
        {
            ...
            TypedArray b = c.obtainStyledAttributes(attrs,
                    net.opacapp.multilinecollapsingtoolbar.R.styleable.CollapsingToolbarScrimMode);
            mScrimMode = b.hasValue(net.opacapp.multilinecollapsingtoolbar.R.styleable.CollapsingToolbarScrimMode_layout_scrimMode) ? b.getInteger(
                    net.opacapp.multilinecollapsingtoolbar.R.styleable.CollapsingToolbarScrimMode_layout_scrimMode, 0) : 0;
            b.recycle();
        }
         ...
         *
         * @param collapseMode
         *         one of {@link #COLLAPSE_MODE_OFF}, {@link #COLLAPSE_MODE_PIN} or {@link #COLLAPSE_MODE_PARALLAX}.
         */
         ...
         *
         * @return the current mode. One of {@link #COLLAPSE_MODE_OFF}, {@link #COLLAPSE_MODE_PIN} or {@link #COLLAPSE_MODE_PARALLAX}.
         */
        @CollapseMode
